...
private ProgressBar progressBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View convertView =  inflater.inflate(R.layout.fragment_science, container, false);

        newsAdapter = new NewsAdapter(getContext(),new ArrayList<>());
        listView = convertView.findViewById(R.id.listView);

        progressBar = convertView.findViewById(R.id.progress_bar_s);
    ...
    public Loader<List<News>> onCreateLoader(int id, @Nullable Bundle args) {
        String url = NewsPreferences.getPreferredUrl(getContext(),"science");
