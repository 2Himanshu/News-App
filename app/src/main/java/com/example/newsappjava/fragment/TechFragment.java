...
import com.example.newsappjava.QyeryUtilis;
...
public class TechFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View convertView =  inflater.inflate(R.layout.fragment_tech, container, false);
    ...
    public Loader<List<News>> onCreateLoader(int id, @Nullable Bundle args) {
        String url = NewsPreferences.getPreferredUrl(getContext(),"technology");


        return new NewsLoader(requireContext(),url);
    }
